...
import trees from "../images/paint.png";
...
const Home = () => (
  <div>
    ...
    <div id="headerColor1">
      <Image className="img1" src={pfp} size='medium' circular />
      <div id="circle-container1">
        <div className="position1 circle1"></div>
      </div>
      <p id="name1"as='h1'>Maris <br /> Herrera</p>
